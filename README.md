...
[![CI](https://github.com/eforus-overseer/octo-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/eforus-overseer/octo-mcp/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/eforus-overseer/octo-mcp.git
cd octo-mcp
pip install -e .
